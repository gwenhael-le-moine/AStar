...
public class Star {
     ...
     public String toString(  ) {
		StringBuilder board = new StringBuilder(  );
          ...
          board.append( BALL + "("+positionBall[0]+";"+positionBall[1]+")\n" )
			 .append( CUBE + "("+positionCube[0]+" )"+positionCube[1]+")\n" )
			 .append( countGifts()+" gifts left.\n" )
			 .append( this.moving + " moving.\n" )
			 .append( ( areWeDoneYet() ) ? "YOU WON" : "not won yet." + "\n" );
          for ( int i = 0 ; i < HEIGHT ; ++i ) {
               for ( int j = 0 ; j < WIDTH ; ++j ) {
				  board.append( symbols.get( this.level.charAt( ( i * WIDTH ) + j ) ) );
               }
			   board.append( "\n" );
          }
